namespace pi_serasa_greenloop
{
	partial class Perfil
	{
		...
		private void InitializeComponent()
		{
			...
			btnExcluirConta_Usuário.Location = new Point(402, 628);
			...
			btnExcluirConta_Usuário.Click += btnExcluirConta_Usuário_Click;
			// 
			// lblCpf
			// 
			...
			lblNome.Location = new Point(220, 42);
